...
public class C06_SoftAssert extends TestBase {
    ...
    public void test01() {
        ...
        (Yani assertAll hardAssertdeki her bir assert gibidir, hatayi yakalarsa calisma durur)
         */

        System.out.println("assertion'lardan sonra fail olan olursa, burasi calismaz");

        // requirement'da test edin derse Assert kullaniyoruz
        // softAssert'u kullanmamiz gerekirse verification kelimesi soruda gecer
